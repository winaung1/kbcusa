...
import KBCLParagraph3Left from './KBCLParagraph3Left'
import KBCLParagraph4Left from './KBCLParagraph4Left'
function KarenBaptistChurchOfLincoln() {
  return (
    <div className='w-[1023px] mx-auto min-h-screen'>
    <Header/>
    <Navbar/>
    <div><Image className="object-cover" src='/images/KarenBaptistChurchOfLincolnImage/LincolnKarenBaptistChurch.jpg' width={1024} height={260} alt='lincoln'/></div>
    <div className='flex bg-white'>
      <ContentTemplatesLeft
        ...
        para3={<KBCLParagraph3Left/>}
        para4={<KBCLParagraph4Left/>}
