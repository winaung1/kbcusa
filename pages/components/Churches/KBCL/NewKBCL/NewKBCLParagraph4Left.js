...
function NewKBCLParagraph4Left() {
  ...
  return (
    ...
    <div className='flex justfy-between space-x-5'>
        ...
        <div>
          <h1 className="cursor-pointer"  onClick={handleClickYouth}>1.LKBC တၢ်အိၣ်ဖှိၣ်အတၢ်ကွဲးနီၣ်</h1>
          <div>
...
export default NewKBCLParagraph4Left