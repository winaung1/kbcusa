...
function NewHteeGerNeeKarenBaptistChurch() {
  return (
    <div className='w-[1023px] mx-auto min-h-screen'>
    <Header/>
    <Navbar/>
    <Image src='/images/TeeGerNeeKarenBaptistChurch/Hteegernee.png' width={1024} height={260} alt='omaha'/>
...
export default NewHteeGerNeeKarenBaptistChurch